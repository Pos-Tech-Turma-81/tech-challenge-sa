...
class ClienteApiTest {
    ...
    class CadastrarClienteApi {
        ...
        void deveRetornarCreatedAoCadastrarCliente() {
            ...
            when(clienteController.cadastrar(any(ClienteDTO.class)))
                    .thenReturn(ResponseEntity.status(HttpStatus.CREATED).body(clienteDto));
    ...
    class BuscarClienteApi {
        ...
        void deveRetornarOkAoBuscarCliente() {
            ...
            when(clienteController.getCliente(cpf))
